...
namespace LightBulb.Domain.Tests
{
    public class SolarTimesSpecs
    {
            ...
            GeoLocation location, DateTimeOffset instant, SolarTimes expectedSolarTimes)
        {
            ...
            // Assert
            solarTimes.Sunrise.AsTimeSpan().Should().BeCloseTo(expectedSolarTimes.Sunrise.AsTimeSpan(), TimeSpan.FromMinutes(3));
            solarTimes.Sunset.AsTimeSpan().Should().BeCloseTo(expectedSolarTimes.Sunset.AsTimeSpan(), TimeSpan.FromMinutes(3));
        }
    }
}