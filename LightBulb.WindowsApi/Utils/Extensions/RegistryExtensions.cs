...
{
    public static RegistryKey OpenKey(this RegistryHive hive, RegistryView view = RegistryView.Default) =>
        RegistryKey.OpenBaseKey(hive, view);

    public static string GetShortMoniker(this RegistryHive hive) => hive switch
    {
